...
const filterNavByPermissions = () => {
    const cu = JSON.parse(localStorage.getItem("currentUser") || "null");
    if (!cu?.username) return; 

    const perms = getPermissions(cu.username);

    document.querySelectorAll(".navigation-wrapper ul li[data-page]").forEach((li) => {
        const page = li.getAttribute("data-page");
        const permKey = NAV_PERM_MAP[page];
        if (!permKey) return;

        // permission false bo'lsa — nav item korinmaydi.
        li.style.display = perms[permKey] === false ? "none" : "";
    });
};
...
navigationWrapper.innerHTML = `
    ...
    <ul>
        <li data-page="Tests" class="${savedPage === "Tests" ? "active" : ""}">
            <a href="#tests">
        ...
        <li data-page="Vacations" class="${savedPage === "Vacations" ? "active" : ""}">
            <a href="#vacations">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
        ...
        <li data-page="Employees" class="${savedPage === "Employees" ? "active" : ""}">
            <a href="#employees">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
        ...
        <li data-page="Messenger" class="${savedPage === "Messenger" ? "active" : ""}">
            <a href="#messenger">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
        ...
        <li data-page="Infoportal" class="${savedPage === "Infoportal" ? "active" : ""}">
            <a href="#infoportal">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
